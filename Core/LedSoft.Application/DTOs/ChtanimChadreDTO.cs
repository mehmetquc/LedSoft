...
namespace LedSoft.Application.DTOs
{
    public class ChtanimChadreDTO
    {
        ...
        public long? Kategori6id { get; set; }

        public long? Kategori7id { get; set; }

        public long? Kategori8id { get; set; }

        public long? Kategori9id { get; set; }

        public long? Kategori10id { get; set; }
